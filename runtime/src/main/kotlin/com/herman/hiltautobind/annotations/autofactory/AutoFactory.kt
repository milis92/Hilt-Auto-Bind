 ...
 * ```
 *
 * #### Multibindings set container
 * With dagger multibindings, you do not have to explicitly provide a set/map container if the bound set/map is
 * going to have at least one element. If the resulting set could be empty, a set container needs to be provided.
 ...
 * annotation matched by a specified supertype and any [javax.inject.Qualifier] applied to the factory function___
 *
 * @see AutoFactory
 */
@Target(AnnotationTarget.FUNCTION)
