...
Dagger binds SomethingImpl to SomethingImpl, Something __cannot be used__ as an injected dependency
...
Dagger binds SomethingImpl to Something, Something __can be used__ as an injected dependency
...
Note that if the class has no super types, the annotation processor will bind a type to itself.
...
Dagger requires a module to be created and a function to be annotated with `@Provides`
...
The annotation processor generates a module for the `SomethingImpl` class automatically
