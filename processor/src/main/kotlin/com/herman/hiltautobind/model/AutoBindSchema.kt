...
class AutoBindSchema private constructor(
    ...
    constructor(classDeclaration: KSClassDeclaration) : this(
        ...
        otherAnnotations = classDeclaration.annotations.filter { annotations ->
            annotations in bindAnnotations
    ...
    val boundSuperType: ClassName
        get() = autoBindAnnotation.getArgument(autoBindAnnotation.getBoundSuperTypeArgumentName)?.let {
            ...
            it != autoBindAnnotation.getDefaultArgument(autoBindAnnotation.getBoundSuperTypeArgumentName)
        } ?: annotatedClass
    ...
    override val isTestModule: Boolean
        get() = autoBindAnnotation.annotationType == TestAutoBind::class
    ...
    private val KSAnnotation.getBoundSuperTypeArgumentName: String
        get() = when (annotationType) {
            AutoBind::class -> AutoBind::superType.name
            TestAutoBind::class -> TestAutoBind::superType.name
    ...
    private val KSAnnotation.getBoundComponentArgumentName: String
        get() = when (annotationType) {
            AutoBind::class -> AutoBind::component.name
            TestAutoBind::class -> TestAutoBind::component.name
